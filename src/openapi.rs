...
// Variant when legacy-auth-flat feature is enabled: include deprecated LoginResponse schema
...
#[openapi(
    ...
    components(
        schemas(
            ...
            // Legacy schema (reference only) included under feature
...
// Variant when legacy-auth-flat feature is disabled: do NOT include LoginResponse in schemas
