...
fn test_pagination_response() {
    use cms_backend::utils::api_types::{Pagination, PaginatedResponse};
    use serde_json::json;
...
fn test_validation_error_response() {
    ...
    let response: ApiResponse<()> = ApiResponse::error_with_validation(
...
fn test_api_error_codes() {
    ...
    for (code, expected_len) in &error_codes {
        ...
        assert_eq!(code.len(), *expected_len, "Error code '{}' should be {} characters", code, expected_len);
    }
}
